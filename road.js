...
road.prototype.writeVehicles= function(umin,umax) {
	...
	if((this.veh[i].u>=uminLoc)&&(this.veh[i].u<=umaxLoc)){
        var log = " veh["+i+"].id="+this.veh[i].id
...
road.prototype.writeVehiclesSimple= function(umin,umax) {
    ...
    for(var i=0; i<this.veh.length; i++){
      if((this.veh[i].u>=uminLoc)&&(this.veh[i].u<=umaxLoc)){
        /*
        var log = " veh["+i+"].type="+this.veh[i].type
		    +"  id="+this.veh[i].id
		    +"  u="+parseFloat(this.veh[i].u,10).toFixed(1)
		    +"  v="+parseFloat(this.veh[i].v,10).toFixed(1)
		    +"  lane="+this.veh[i].lane
            ...
            +"";
        */
        log +=      parseFloat(itime*dt,10).toFixed(3) + "," + 
                    this.roadID + "," +
                    this.veh[i].id + "," +
                    this.veh[i].type + "," +
                    this.veh[i].lane + "," +
                    parseFloat(this.veh[i].u,10).toFixed(2) + "," +
                    parseFloat(this.veh[i].v,10).toFixed(2) + "," +
                    parseFloat(this.veh[i].speed,10).toFixed(2) + "," +
                    parseFloat(this.veh[i].acc,10).toFixed(2) + "," +
